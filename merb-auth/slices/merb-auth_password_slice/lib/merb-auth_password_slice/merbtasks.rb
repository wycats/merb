namespace :slices do
  namespace :"merb-auth_password_slice" do
    ...
    desc "Freeze MerbAuthPasswordSlice into your app (only merb-auth_password_slice/app)" 
    ...
    namespace :freeze do
      ...
      task :gem do
        begin
          Object.const_get(:Freezer).freeze(ENV["GEM"] || "merb-auth_password_slice", ENV["UPDATE"], ENV["MODE"] || 'rubygems')
        rescue NameError
          puts "! dependency 'merb-freezer' missing"
        end
      end
      
      desc "Freezes MerbAuthPasswordSlice by copying all files from merb-auth_password_slice/app to your application"
      task :app do
        puts "Copying all merb-auth_password_slice/app files to your application - resolves any collisions"
      ...
      desc "Freezes MerbAuthPasswordSlice as a gem and copies over merb-auth_password_slice/app"
