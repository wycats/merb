...
Gem::Specification.new do |s|
  s.name = %q{merb_auth_password_slice}
  s.version = "0.9.8"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<merb_auth-core>, [">= 0.1.1"])
    else
      s.add_dependency(%q<merb_auth-core>, [">= 0.1.1"])
    end
  else
    s.add_dependency(%q<merb_auth-core>, [">= 0.1.1"])
  end
