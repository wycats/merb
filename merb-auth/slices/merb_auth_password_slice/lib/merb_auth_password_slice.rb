if defined?(Merb::Plugins)
  ...
  Merb::Plugins.add_rakefiles "merb_auth_password_slice/merbtasks", "merb_auth_password_slice/slicetasks", "merb_auth_password_slice/spectasks"
  ...
  Merb::Slices::config[:"merb_auth_password_slice"][:layout] ||= :application
  ...
  module MerbAuthPasswordSlice
    ...
    def self.init
      require 'merb_auth-more/strategies/basic/password_form'
      require 'merb_auth-more/strategies/basic/basic_auth'
    ...
    def self.setup_router(scope)
      ...
      scope.match("/login", :method => :put).to(:controller => "sessions", :action => "update").name(:"merb_auth_perform_login")
      scope.match("/logout").to(:controller => "sessions", :action => "destroy").name(:"merb_auth_logout")
    end
