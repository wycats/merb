...
require File.join(File.expand_path(File.dirname(__FILE__)), "..", ".." ,"lib", "merb_auth-more", "strategies", "abstract_password")
require File.join(File.expand_path(File.dirname(__FILE__)), "..", ".." ,"lib", "merb_auth-more", "mixins", "salted_user")
