...
# To change the login or password field to a field of your choice
  update the Merb::Authentication::Strategies::Basic::Base.login_param and password_param

<pre><code>
class Merb::Authentication::Strategies::Basic::Base < Merb::Authentication::Strategy
