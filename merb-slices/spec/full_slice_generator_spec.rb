  ...
  describe "templates" do
    ...
    it "should create a number of templates" do
      ...
      expected = [
        ...
        "testing/lib", "testing/lib/testing", "testing/lib/testing/merbtasks.rb", 
        "testing/lib/testing/slicetasks.rb", "testing/lib/testing/spectasks.rb", 
        "testing/lib/testing.rb", "testing/LICENSE", "testing/public", 
        "testing/public/javascripts", "testing/public/javascripts/master.js", 
        "testing/public/stylesheets", "testing/public/stylesheets/master.css", 
        "testing/Rakefile", "testing/README", "testing/spec", 
        "testing/spec/controllers", "testing/spec/controllers/main_spec.rb", 
        "testing/spec/spec_helper.rb", "testing/spec/testing_spec.rb", 
        "testing/stubs", "testing/stubs/app", "testing/stubs/app/controllers", 
        "testing/stubs/app/controllers/application.rb", 
